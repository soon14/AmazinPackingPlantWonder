...
<jsp lang="en">
  ...
  <!-- Dialog box for information -->
		  ...
		  <div id="dialog-message" title="Information Message">
		  <p>
        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
           ...
           <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <li><a href="PackerDashboard.jsp">Packer Dashboard</a></li>
                    </ul>
                    </li>
                    </ul>
                    <!--  <ul class="nav side-menu">
                    ...
                    <ul class="nav child_menu">
                    <li><a href="BustedBags.jsp">Busted Bags</a></li>
                    <li><a href="DeviceConfiguration.jsp">Device Configuration</a></li>
                    
                    <li><a href="PackerMaster.jsp">Packer master</a></li>
                    <li><a href="PlantMaster.jsp">Plant master</a></li>
                    <li><a href="SquenceLoader.jsp">Sequence Loader</a></li>
                  ...
                  <ul class="nav side-menu">
                   ...
                   <!--  <li><a href="DeviceConfiguration.jsp">Device Configuration</a></li> -->
                    ...
                    <li><a href="BustedBags.jsp">Busted Bags</a></li>
                    <li><a href="BustedBags.jsp">CreateUser</a></li>
                    <!-- <li><a href="SquenceLoader.jsp">Sequence Loader</a></li> -->
                    <!-- <li><a href="VehcileMaster.jsp">Vehicle master</a></li> -->
                   <!--  <li><a href="VehcileStatus.jsp">Vehicle Status</a></li> -->
                   <!--  <li><a href="PlantGateEntryDashboard.jsp">Plant Gate Entry Dashboard</a></li>
